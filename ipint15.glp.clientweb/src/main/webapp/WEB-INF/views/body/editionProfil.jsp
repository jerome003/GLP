...
<body>
	<div class="section">
		<div class="container">
			<form action="" method="post" onsubmit="return confirm('Voulez vous vraiment enregistrer ?');" name="modif_form">
				<div class="row">
					<div class="row">
						...
						<div class="row">
							<div class="col-sm-offset-5 col-sm-2 text-center">
								<button type="submit" onclick="SoumettreFormulaire();"
								...
								<div class="divFormation" name="divFormation">
									<div class="row">
										...
										<label id="labelFormEtabl${loop.index}"
											...
											class="col-md-2">Début :</label> <input
