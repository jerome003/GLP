...
<div class="section">
	<div class="container">
				<div class="row">
			<div class="col-md-12">
				<h1>Authentification d'un modérateur</h1>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-offset-2 col-md-8">
				<form:form class="form-horizontal" role="form" method="post" commandName="command" action="doConnexionModerateur">
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-6">
							<button type="submit" value="Add Moderateur" class="btn btn-default">
								Valider <br>
							</button>
						</div>
					</div>
