...
<div class="section">
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12">
				<h1>Résultat de la recherche ancien etudiant : ${recherche}</h1>
			</div>
		</div>
		<div class="row">
			<table class="table table-striped table-hover table-users">
		...
		<div class="row">
			<div class="col-md-12">
				<h1>Résultat de la recherche etudiant : ${recherche}</h1>
			</div>
		</div>
		<div class="row">
			<table class="table table-striped table-hover table-users">
		...
		<div class="row">
			<div class="col-md-12">
				<h1>Résultat de la recherche d'enseignant : ${recherche}</h1>
			</div>
		</div>
		<div class="row">
			<table class="table table-striped table-hover table-users">
