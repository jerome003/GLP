...
public class EtudiantCatalogImplTest {
	...
	public void testAddExperience() {
		etuBean.addExperience(etudiant, "Stage");
		etudiant = etuBean.getEtudiant(etudiant.getId());
	...
	public void testGetExperiences () {
		etuBean.addExperience(etudiant,"Stage2");
		etuBean.addExperience(etudiant, "Stage3");
		etudiant = etuBean.getEtudiant(etudiant.getId());
	...
	public void testDeleteExpProList() {
		etuBean.addExperience(etu,"Stage2");
		etuBean.addExperience(etu, "Stage3");
